...
\begin{itemize}
  ...
  \item \textbf{FR (Yêu cầu chức năng):}
    \begin{itemize}
      \item Lấy mẫu định kỳ với tần suất có thể tùy chỉnh (ví dụ: 1--60 giây/lần).
      \item Chuẩn hóa dữ liệu thô sang các đơn vị đo lường chuẩn (°C, \%RH, lux).
      \item Hiển thị dữ liệu realtime trên Dashboard của App/Web dưới dạng số và biểu đồ cơ bản.
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{FR:}
    \begin{itemize}
      \item Cấu hình (CRUD) các bộ ngưỡng ngày/đêm và các kịch bản tự động.
      \item Trigger hành động khi vượt ngưỡng: Tự bật đèn khi thiếu sáng, bật quạt/điều hòa khi nhiệt độ cao.
